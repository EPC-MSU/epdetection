...
Модуль представляет собой набор функций для распознавания компонентов на печатных платах (см. elements.md). Существует пять публичных функций, которыми следует пользоваться, импортируя модуль.
